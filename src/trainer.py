...
class Trainer:
  ...
  def fit(self, train_loader, val_loader, n_epochs, log_steps=None, max_first_log_steps=None, max_time=None):
    ...
    for epoch in range(1, n_epochs + 1):
      ...
      if log_flag and ((epoch <= max_first_log_steps) or (self.current_epoch % log_steps == 0)):
